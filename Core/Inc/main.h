...
#define TACHO2_Pin GPIO_PIN_2
#define TACHO2_GPIO_Port GPIOC
#define TACHO2_EXTI_IRQn EXTI2_IRQn
...
#define TACHO4_Pin GPIO_PIN_14
#define TACHO4_GPIO_Port GPIOG
#define TACHO4_EXTI_IRQn EXTI15_10_IRQn
